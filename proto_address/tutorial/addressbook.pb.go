...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_baef33a9afa7ed58, []int{0, 0}
}
...
func (*Person) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_baef33a9afa7ed58, []int{0}
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_baef33a9afa7ed58, []int{1}
}
...
func init() { proto.RegisterFile("addressbook.proto", fileDescriptor_addressbook_baef33a9afa7ed58) }

var fileDescriptor_addressbook_baef33a9afa7ed58 = []byte{
